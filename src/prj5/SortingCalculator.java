 ...
 * display. All sort or get methods remove duplicates but still have full
 * functionality logistically and in actuality.
 * 
 * @author naren
 * @version Nov 12, 2023
 */
public class SortingCalculator
{
    ...
    {
        return ((user.getComments() + user.getLikes())
            / (double)user.getViews()) * 100;
    }
