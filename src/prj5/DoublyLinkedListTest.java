...
public class DoublyLinkedListTest extends TestCase {
    ...
    public void setUp() {
        ...
        list2.add(new User("February", "narnarnoscoper", "2", "India", "Cars",
            0, 35, 1, 2, 1));
        list2.add(new User("February", "jchen", "3", "China", "Cars", 0, 35, 1,
            3, 1));
        list2.add(new User("March", "jchen", "1", "China", "Cars", 0, 35, 1, 1,
            1));
        list2.add(new User("March", "jchen", "5", "China", "Cars", 0, 35, 1, 5,
            1));
        list2.add(new User("March", "jchen", "4", "China", "Cars", 0, 35, 1, 4,
            1));
    }
    ...
    public void testReach() {
        ...
        list2.add(new User("February", "jchen2", "7", "China", "Cars", 0, 35, 1,
            7, 1));
        assertEquals(6, list2.getLength());
        assertEquals(700, list2.getEntry(5).getIndividualReachRate(), 0.1);
        list2.add(new User("February", "jchen", "6", "China", "Cars", 0, 35, 1,
            6, 1));
    ...
    public void testSortAlphabetical() {
        list2.clear();
        list2.add(new User("February", "narnarnoscoper", "NarenDaBeast",
            "India", "Cars", 1011, 35, 100987, 53809, 29492));
        assertEquals("NarenDaBeast", list2.getEntry(0).getChannelName());
        list2.add(new User("February", "jchen", "JoeyDAMonster", "China",
            "Cars", 1011, 35, 100987, 20000, 29492));
        list2.add(new User("March", "jchen", "JoeyCHEN", "China", "Cars", 10,
            10, 1, 20, 10));
        assertEquals("NarenDaBeast", list2.getEntry(0).getChannelName());
