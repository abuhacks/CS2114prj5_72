...
public class InputFileReader
{
    ...
    /*
     * private void output() { DoublyLinkedList<User> newList =
     * newTemp.sortByName(); DoublyLinkedList<User> newList2 =
     * newTemp.sortByReachRate(); for(int i = 0; i < newList.getLength(); i++) {
     * System.out.println(newList.getEntry(i).getChannelName());
     * System.out.println("traditional: " +
     * newTemp.getTraditionalRate(newList.getEntry(i)));
     * System.out.println("=========="); if(i == newList.getLength() - 1) {
